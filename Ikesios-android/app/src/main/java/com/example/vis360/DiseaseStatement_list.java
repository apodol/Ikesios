...
public class DiseaseStatement_list extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i=new Intent (getApplicationContext(),DiseaseStatement_other.class);
                startActivity(i);
            }
        });
